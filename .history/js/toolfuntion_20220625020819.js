...
function HEXtoRGB(){
    ...
    console.log(result);
    document.getElementById("resultR").value = result[1];
    document.getElementById("resultG").setAttribute('value', parseInt(result[2], 16));
    document.getElementById("resultB").setAttribute('value', parseInt(result[3], 16));
}
